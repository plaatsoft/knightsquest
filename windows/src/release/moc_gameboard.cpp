...
**
** Created: Sat 16. Oct 08:41:12 2010
...
static const char qt_meta_stringdata_Gameboard[] = {
    "Gameboard\0\0on_nextTurnButton_clicked()\0"
    "statemachine()\0"
};

const QMetaObject Gameboard::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Gameboard,
...
int Gameboard::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: on_nextTurnButton_clicked(); break;
        case 1: statemachine(); break;
        default: ;
        }
        _id -= 2;
    }
