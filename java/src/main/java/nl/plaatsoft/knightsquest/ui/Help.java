...
public class Help extends MyPanel {
	...
	public void draw() {
    	...
    	getChildren().add( new MyLabel(40, y, "Icon", 20, "white", "-fx-font-weight: bold;"));
    	...
    	y+=30;    	
    	getChildren().add( new MyImageView(50,y+5,SoldierUtils.get(SoldierEnum.TOWER), 0.9, true));
    	...
    	y+=25;
    	getChildren().add( new MyImageView(50,y+5,SoldierUtils.get(SoldierEnum.PAWN), 1, true));
    	getChildren().add( new MyLabel(130, y, "Pawn", 20, "white"));
    	getChildren().add( new MyLabel(250, y, ""+SoldierEnum.PAWN.getValue(), 20, "white"));
    	getChildren().add( new MyLabel(400, y, ""+SoldierUtils.getFoodNeeds(SoldierEnum.PAWN), 20, "white"));
    	y+=25;
    	getChildren().add( new MyImageView(50,y+5,SoldierUtils.get(SoldierEnum.BISHOP), 1, true));
    	getChildren().add( new MyLabel(130, y, "Bishop", 20, "white"));
    	getChildren().add( new MyLabel(250, y, ""+SoldierEnum.BISHOP.getValue(), 20, "white"));
    	getChildren().add( new MyLabel(400, y, ""+SoldierUtils.getFoodNeeds(SoldierEnum.BISHOP), 20, "white"));
    	y+=25;
    	getChildren().add( new MyImageView(50,y+5,SoldierUtils.get(SoldierEnum.HORSE), 1, true));
    	getChildren().add( new MyLabel(130, y, "Horse", 20, "white"));
    	getChildren().add( new MyLabel(250, y, ""+SoldierEnum.HORSE.getValue(), 20, "white"));
    	getChildren().add( new MyLabel(400, y, ""+SoldierUtils.getFoodNeeds(SoldierEnum.HORSE), 20, "white"));
    	y+=25;
    	getChildren().add( new MyImageView(50,y+5,SoldierUtils.get(SoldierEnum.QUEEN), 1, true));
    	getChildren().add( new MyLabel(130, y, "Queen", 20, "white"));
    	getChildren().add( new MyLabel(250, y, ""+SoldierEnum.QUEEN.getValue(), 20, "white"));
    	getChildren().add( new MyLabel(400, y, ""+SoldierUtils.getFoodNeeds(SoldierEnum.QUEEN), 20, "white"));
    	y+=25;
    	getChildren().add( new MyImageView(50,y+5,SoldierUtils.get(SoldierEnum.KING), 0.9, true));
    	getChildren().add( new MyLabel(130, y, "King", 20, "white"));
    	getChildren().add( new MyLabel(250, y, ""+SoldierEnum.KING.getValue(), 20, "white"));
    	getChildren().add( new MyLabel(400, y, ""+SoldierUtils.getFoodNeeds(SoldierEnum.KING), 20, "white"));
    	y+=25;
    	getChildren().add( new MyImageView(50,y+5,SoldierUtils.get(SoldierEnum.CROSS), 1, true));
